...
public class tablaConsulta {
    ...
    public void ver_tabla(JTable pTabla,ArrayList<String> consulta){
        ...
        tablaPredeterminada.addColumn("SOLICITUD");
        tablaPredeterminada.addColumn("IDMATERIAPRIMA");
        tablaPredeterminada.addColumn("UNIDADMEDIDA");
        tablaPredeterminada.addColumn("CANTIDADFALTANTE");
